...
public class MainActivity extends AppCompatActivity {
    ...
    // DONE TODO (1) Declare and instantiate a static ArrayList of Strings called mLifecycleCallbacks
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int callBackSize = mLifecycleCallbacks.size();

        if (mLifecycleCallbacks.size() > 0) {
            for (int i=callBackSize-1; i>0; i--){
                Log.i("ART", "onCreate: " + i);
