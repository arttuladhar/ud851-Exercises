...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    // DONE TODO (1) Add an interface called ListItemClickListener
    // DONE TODO (2) Within that interface, define a void method called onListItemClick that takes an int as a parameter

    // DONE TODO (4) Add a ListItemClickListener as a parameter to the constructor and store it in mOnClickListener
    /**
     ...
     */
    public GreenAdapter(ListItemClickListener listItemClickListener, int numberOfItems) {
    ...
    // DONE TODO (5) Implement OnClickListener in the NumberViewHolder class
    /**
