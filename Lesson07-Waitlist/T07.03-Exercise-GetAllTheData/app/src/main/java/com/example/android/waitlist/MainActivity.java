...
public class MainActivity extends AppCompatActivity {
    ...
    // DONE TODO (1) Create a local field member of type SQLiteDatabase called mDb
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // DONE TODO (2) Create a WaitlistDbHelper instance, pass "this" to the constructor as context
        WaitlistDbHelper waitlistDbHelper = new WaitlistDbHelper(this);

        // DONE TODO (3) Get a writable database reference using getWritableDatabase and store it in mDb
        mDb = waitlistDbHelper.getWritableDatabase();

        // DONE TODO (4) call insertFakeData from TestUtil and pass the database reference mDb
