    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String inputMsg = mNameEntry.getText().toString();

                intent.putExtra("data", inputMsg);
...
// DONE TODO (1) Use Android Studio's Activity wizard to create a new Activity called ChildActivity