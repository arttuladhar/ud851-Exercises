...
// DONE TODO (1) implement LoaderManager.LoaderCallbacks<String> on MainActivity
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    // DONE TODO (2) Create a constant int to uniquely identify your loader. Call it GITHUB_SEARCH_LOADER
    ...
    private void makeGithubSearchQuery() {
        ...
        // DONE TODO (17) If no search was entered, indicate that there isn't anything to search for and return
    ...
    public Loader<String> onCreateLoader(int i, final Bundle bundle) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                try {
                    searchUrl = new URL(searchQueryStringUrl);
    ...
    // DONE TODO (3) Override onCreateLoader
    // Within onCreateLoader

        // DONE TODO (4) Return a new AsyncTaskLoader<String> as an anonymous inner class with this as the constructor's parameter
            // DONE TODO (5) Override onStartLoading
                // Within onStartLoading

                // DONE TODO (6) If args is null, return.

                // DONE TODO (7) Show the loading indicator

                // DONE TODO (8) Force a load
                // END - onStartLoading

            // DONE TODO (9) Override loadInBackground

                // Within loadInBackground
                // DONE TODO (10) Get the String for our URL from the bundle passed to onCreateLoader

                // DONE TODO (11) If the URL is null or empty, return null

                // DONE TODO (12) Copy the try / catch block from the AsyncTask's doInBackground method
                // END - loadInBackground

    // DONE TODO (13) Override onLoadFinished

        // Within onLoadFinished
        // DONE TODO (14) Hide the loading indicator

        // DONE TODO (15) Use the same logic used in onPostExecute to show the data or the error message
        // END - onLoadFinished

    // DONE TODO (16) Override onLoaderReset as it is part of the interface we implement, but don't do anything in this method
